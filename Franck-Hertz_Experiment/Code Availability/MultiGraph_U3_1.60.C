    ...
    TCanvas* c1 = new TCanvas("c1", "Franck-Hertz Experiment U3=1.60", 1400, 900);

    // Load your data (make sure the file path is correct)
    TGraphErrors* mygraph = new TGraphErrors("U3_1.60_U2_IA.txt");

    // Graph cosmetics
    mygraph->SetTitle(" U1=1.35 V,  U3=1.60 V,  T=188 C");
