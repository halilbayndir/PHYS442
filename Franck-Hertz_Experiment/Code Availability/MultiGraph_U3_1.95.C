    ...
    TCanvas* c1 = new TCanvas("c1", "Franck-Hertz Experiment U3=1.95", 1400, 900);

    // Load your data (make sure the file path is correct)
    TGraphErrors* mygraph = new TGraphErrors("U3_1.95_U2_IA.txt");

    // Graph cosmetics
    mygraph->SetTitle(" U1=1.35 V,  U3=1.95 V,  T=188 C");
