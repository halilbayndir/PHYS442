    ...
    TCanvas* c1 = new TCanvas("c1", "Franck-Hertz Experiment U1=1.59", 1400, 900);

    // Load your data (make sure the file path is correct)
    TGraphErrors* mygraph = new TGraphErrors("U1_1.59_U2_IA.txt");

    // Graph cosmetics
    mygraph->SetTitle(" U1=1.59 V,  U3=1.82 V,  T=188 C");
