    ...
    TCanvas* c1 = new TCanvas("c1", "Franck-Hertz Experiment U3=1.76", 1400, 900);

    // Load your data (make sure the file path is correct)
    TGraphErrors* mygraph = new TGraphErrors("U3_1.76_U2_IA.txt");

    // Graph cosmetics
    mygraph->SetTitle(" U1=1.35 V,  U3=1.76 V,  T=188 C");
    ...
    // Peak 1
    TF1* gauss1 = new TF1("gauss1", "[0]*TMath::Gaus(x,[1],[2])", 4.2, 6.5);
    ...
    // Peak 3
    TF1* gauss3 = new TF1("gauss3", "[0]*TMath::Gaus(x,[1],[2])",13.2 ,16.4);
