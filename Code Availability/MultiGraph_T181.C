    ...
    TCanvas* c1 = new TCanvas("c1", "Franck-Hertz Experiment T=181", 1400, 900);

    // Load your data (make sure the file path is correct)
    TGraphErrors* mygraph = new TGraphErrors("T181_U2_IA.txt");

    // Graph cosmetics
    mygraph->SetTitle(" U1=1.40 V,  U3=1.81 V,  T=181 C");
